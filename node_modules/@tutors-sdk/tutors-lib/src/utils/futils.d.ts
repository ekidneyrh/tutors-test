...
export declare function readYaml(path: string): Properties;
export declare function readEnrollment(path: string): Properties;
export declare function readCalendar(path: string): Properties;
